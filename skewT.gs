...
'set y 57'
'set z 1 30'
'define vel=mag(u,v)*1.944'
'define wdir=57.3*atan2(u,v)+180'
rc=plotskew(tempc,dewptc,-1,-1)
...
* Last Minor Update:  March 21, 2017
* Last Major Update:  August 29, 2009  ** IMPORTANT UPDATE **
* http://moe.met.fsu.edu/~rhart/software.php
*
* Recent Changes:
*
* 03/21/17 - Based on overall improved computational environments, increased the pressure 
*            increment for the theta and theta-w lines, such that the adiabatics were more
*            accurate and also were flush with the frame.   Added T and Td for the most
*            unstable parcel trace output.   Modifications of default colors and font sizes
*            to make the plot more legible.  Also, a few modifications to prevent divide by 
*            zero when wind speed in output is exactly zero for the hodograph and wind profile.
*
...
*
* 10/21/96 - First released version that was embarrassingly messy.
*
*
* Features:
...
If (DrawIndx = 1) 
   ...
   rec=GHBCAPE(sndtemp,snddewp,MAscentI*100,1,500,MAscentT)
   Pos=subwrd(rec,1)
   CIN=subwrd(rec,2)
   ...
   If (SfcPlev != PMaxThee) 
      ...
      rec=GHBCAPE(sndtemp,snddewp,MAscentI*100,2,500,MAscentT)
      PosMax=subwrd(rec,1)
      CINMax=subwrd(rec,2)
   Else
      LIMax=SLI
   ...
   "set string 1 l 3"
   "set line 0 1 3"
   "draw recf  "Text1XC-0.75 " " Text1YC-0.40 " " Text1XC+0.90 " " Text1YC+0.25
   "set line 1 1 3"
   "draw rec  "Text1XC-0.75 " " Text1YC-0.40 " " Text1XC+0.90 " " Text1YC+0.25
   "draw string "Text1XC-0.70 " " Text1YC+0.10"  K" 
   "draw string "Text1XC+0.35 " " Text1YC+0.10" " math_int(K)      
   "draw string "Text1XC-0.70 " " Text1YC-0.10 "  TT" 
   "draw string "Text1XC+0.35 " " Text1YC-0.10 " " math_int(tt)
   "draw string "Text1XC-0.70 " " Text1YC-0.25 "  PW (cm)" 
   "draw string "Text1XC+0.35 " " Text1YC-0.25 " " math_int(pw*100)/100
   "set line 0 1 3"
   "draw recf  "Text2XC-0.75 " " Text2YC-0.60 " " Text2XC+0.90 " " Text2YC+0.85
   "set line 1 1 3"
   ...
   "draw string "Text2XC+0.35 " " Text2YC+0.15 " " math_int(Sfcdewp*10)/10
   "draw string "Text2XC-0.70 " " Text2YC "   `3z`0`bE`n (K)"
   "draw string "Text2XC+0.35 " " Text2YC " " math_int(SfcThee*10)/10
   "draw string "Text2XC-0.70 " " Text2YC-0.15 "  LI (`3.`0C)"
   "draw string "Text2XC+0.35 " " Text2YC-0.15 " " math_nint(SLI)
   "draw string "Text2XC-0.70 " " Text2YC-0.30 "  CAPE (Jkg`a-1`n)"
   "draw string "Text2XC+0.35 " " Text2YC-0.30 " " math_int(Pos)   
   "draw string "Text2XC-0.70 " " Text2YC-0.45 "  CIN (Jkg`a-1`n)"
   "draw string "Text2XC+0.35 " " Text2YC-0.45 " " math_int(CIN)      
   "set line 0 1 3"
   "draw recf  "Text3XC-0.75 " " Text3YC-0.55 " "  Text3XC+0.90 " " Text3YC+0.85
   "set line 1 1 3"
   ...
   "draw string "Text3XC-0.70 " " Text3YC+0.15 "  Dewp (`3.`0C)" 
   "draw string "Text3XC+0.35 " " Text3YC+0.15 " " math_int(Sfcdewp*10)/10
   "draw string "Text3XC-0.70 " " Text3YC " `3z`0`bE`n (K)"
   "draw string "Text3XC+0.35 " " Text3YC " " math_int(MaxThee*10)/10
   "draw string "Text3XC-0.70 " " Text3YC-0.15 " LI (`3.`0C)" 
   "draw string "Text3XC+0.35 " " Text3YC-0.15 " "math_nint(LIMax)
   "draw string "Text3XC-0.70 " " Text3YC-0.30 " CAPE (Jkg`a-1`n)" 
   "draw string "Text3XC+0.35 " " Text3YC-0.30 " "math_int(PosMax) 
   "draw string "Text3XC-0.70 " " Text3YC-0.45 " CIN (Jkg`a-1`n)"
   "draw string "Text3XC+0.35 " " Text3YC-0.45 " " math_int(CINMax) 
Endif
...
* Now, calculate SR and Environmental Helicity
   ...
   Endif
   "set line 0 1 3"
   "draw recf  "Text4XC-0.75 " "Text4YC-0.5 " " Text4XC+0.90 " " Text4YC+0.5
   "set line 1 1 3"
   "draw rec  "Text4XC-0.75 " "Text4YC-0.5 " " Text4XC+0.90 " " Text4YC+0.5
   "draw string "Text4XC-0.35 " " Text4YC+0.40 " Hodograph"
   "draw string "Text4XC-0.70 " " Text4YC+0.20 " EH (Jkg`a-1`n)"
   "draw string "Text4XC+0.35 " " Text4YC+0.20 " "math_int(helic)
   "draw string "Text4XC-0.70 " " Text4YC+0.05 " SREH (Jkg`a-1`n)"
   "draw string "Text4XC+0.35 " " Text4YC+0.05 " " math_int(SRhelic)
   "draw string "Text4XC-0.70 " " Text4YC-0.20 " StmDir (`3.`0)"
   "draw string "Text4XC+0.35 " " Text4YC-0.20 " " math_int(StormDir)
   "draw string "Text4XC-0.70 " " Text4YC-0.35 " StmSpd (kt)"
   "draw string "Text4XC+0.35 " " Text4YC-0.35 " " math_int(_mtk*StormSpd)
Endif
...
tempk=startt+273.15
pres=startp
theta=tempk*math_pow(startp/pres,0.286)
While (pres >= endp) 
    tempk=theta/math_pow(startp/pres,0.286)
    tempc=tempk-273.15
    If (display = 1) 
       xtemp=GetXLoc(tempc,pres)
       "q w2xy "xtemp" "pres
       xloc=subwrd(result,3)
       yloc=subwrd(result,6)
       delp=5
       If ( (xtempold > 90 & xtempold < 110) | (pres < Pmin+10 & pres > Pmin-10))
          delp=1
       Endif
       If (xtempold > -10 & xtempold < 10)
          delp=1
       Endif
